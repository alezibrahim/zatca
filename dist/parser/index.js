...
class XMLDocument {
    ...
    get(path_query, condition) {
        if (!this.xml_object)
            return;
        const { xml_object } = this.getElement(this.xml_object, path_query !== null && path_query !== void 0 ? path_query : "");
    ...
    delete(path_query, condition) {
        if (!this.xml_object)
            return false;
        const { xml_object, parent_xml_object, last_tag } = this.getElement(this.xml_object, path_query !== null && path_query !== void 0 ? path_query : "");
        let query_result = xml_object;
        if (query_result && !(query_result instanceof Array)) {
            query_result = [query_result];
        }
    ...
    set(path_query, overwrite, set_xml) {
        ...
        let { xml_object, parent_xml_object, last_tag } = this.getElement(this.xml_object, path_query !== null && path_query !== void 0 ? path_query : "");
    ...
    toString({ no_header }) {
        let builder_options = Object.assign(Object.assign({}, this.parser_options), { format: true, indentBy: "    " });
